...
import { Compass, Globe as GlobeIcon, RotateCcw } from 'lucide-react';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[12px] text-[#8B93A7]">
              Interactive 3D geolocated signals. Amber indicates high intensity; teal denotes moderate frequency.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          {filters.country && (
            <div className="flex items-center gap-1.5 rounded bg-[#E8944A]/15 border border-[#E8944A]/30 px-2.5 py-1 text-xs text-[#E8944A]">
              <span>Active: <strong>{filters.country}</strong></span>
              <button
                type="button"
          ...
          {leadingCountry && (
            <div className="hidden sm:flex items-center gap-1.5 rounded bg-[#1B273F] border border-[#26314A] px-2.5 py-1 text-xs text-[#ECE9E2]">
              ...
              <span className="text-[#8B93A7] tabular-nums">({leadingCountry.avgIntensity.toFixed(1)})</span>
            </div>
          )}
        ...
        {isLoading && (
          <div className="absolute inset-0 flex items-center justify-center bg-[#0B1220]/80 z-20">
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-xs text-[#8B93A7] tracking-wider">CALIBRATING SIGNALS RADAR...</span>
            </div>
          </div>
        )}
